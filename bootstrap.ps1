function Set-LabArtifacts {
    ...
    $taskXml = Invoke-WebRequest -Uri "https://raw.githubusercontent.com/nrejepov/test-public-scripts/refs/heads/main/task.xml" -UseBasicParsing | Select-Object -ExpandProperty Content
